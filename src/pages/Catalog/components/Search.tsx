...
import { URLSearchParamsInit, useParams } from "react-router-dom";
import { GoSearch } from "react-icons/go";

interface SearchProps {
  setQuery: (val: URLSearchParamsInit) => void;
}

//search bar that allows users to search for movies or TV series
